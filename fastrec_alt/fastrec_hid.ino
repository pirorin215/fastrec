...
HidSwitch hidSwitches[] = {
  {HID_KEY1_GPIO, LOW, 0, HID_STATE_IDLE, 0x00}, // 未使用
  {HID_KEY2_GPIO, LOW, 0, HID_STATE_IDLE, 0x28}, // Enter
  {HID_KEY3_GPIO, LOW, 0, HID_STATE_IDLE, 0x50}, // 左矢印
  {HID_KEY4_GPIO, LOW, 0, HID_STATE_IDLE, 0x0224}, // Android 戻る
  {HID_KEY5_GPIO, LOW, 0, HID_STATE_IDLE, 0x4F}, // 右矢印
...
void sendHidKeyPress(uint16_t keyCode) {
    ...
    if (keyCode >= 0x4F && keyCode <= 0x52) {
        // Keyboard Page (Report ID 1) - Standard 6KRO keyboard format
